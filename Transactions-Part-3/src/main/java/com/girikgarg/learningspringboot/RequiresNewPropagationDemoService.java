...
@Service
public class RequiresNewPropagationDemoService {
    @Autowired
    private InnerService innerService;

    @Transactional(propagation = Propagation.REQUIRED)
    public void outerMethod() {
        System.out.println("[REQUIRES_NEW] Outer method started");
        ...
        System.out.println("[REQUIRES_NEW] Outer method finished");
    }
    ...
    public static class InnerService {
        ...
        public void innerMethod() {
            System.out.println("[REQUIRES_NEW] Inner method executed");
            System.out.println("isActualTransactionActive: " + TransactionSynchronizationManager.isActualTransactionActive());
            System.out.println("Current transaction name: " + TransactionSynchronizationManager.getCurrentTransactionName());
        }
    }
