...
public class OrderController {
    ...
    @GetMapping("/call-product-circuit-breaker/{id}")
    public String callProductWithCircuitBreaker(@PathVariable String id) {
        String response = orderService.invokeProductAPI(id);
        return "Order Service called Product Service with Circuit Breaker: " + response;
    }
}
